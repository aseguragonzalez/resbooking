...
// Cargar dependencias
require_once("model/dto/ChangeDTO.php");
 ...
 * @author Alfonso
 */
class AccountsModel extends \ResbookingModel{
    ...
    /**
     * @ignore
     * Obtener el id del proyecto Resbooking
     * @return type
     */
    private function GetProjectId(){
        // configurar el filtro de búsqueda
        $filter = array( "Name" => "Resbooking" , "Active" => 1);
