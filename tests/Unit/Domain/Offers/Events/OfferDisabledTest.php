...
use App\Domain\Offers\Events\OfferDisabled;
use App\Domain\Offers\ValueObjects\{Project, Settings};
use Faker\Factory as FakerFactory;
use Faker\Generator as Faker;
use PHPUnit\Framework\TestCase;

final class OfferDisabledTest extends TestCase
{
    private Faker $faker;
    private Offer $offer;
    ...
    {
        $event = OfferDisabled::new(offerId: $this->offerId, offer: $this->offer);

        $this->assertNotEmpty($event->getId());
        $this->assertEquals('OfferDisabled', $event->getType());
    ...
    {
        $event = OfferDisabled::build(offerId: $this->offerId, offer: $this->offer, id: $this->faker->uuid);
