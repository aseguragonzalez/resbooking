...
final class DiningAreaRemovedTest extends TestCase
{
    private Faker $faker;
    ...
    public function testCreateNewEvent(): void
    {
        ...
        $event = DiningAreaRemoved::create($restaurantId, $diningArea);

        $this->assertNotEmpty($event->id->value);
        $this->assertSame('dining_area.removed', $event->type);
